...
| 4 | `EMBED-02` | P2 | OPEN — STOP-GATE complete, implementation deferred pending approval | [`docs/BACKLOG.md`](../BACKLOG.md) | [`docs/investigation/embed-02-non-event-embeds-stopgate.md`](../investigation/embed-02-non-event-embeds-stopgate.md) |
...
2. Execute `EMBED-02` only after approval on the STOP-GATE: venues -> members -> blog -> gallery.
