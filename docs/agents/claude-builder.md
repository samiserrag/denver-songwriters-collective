...
Standing brief for Claude Code web builder threads. This file began as the Track 1 builder brief; for current Lane 2, Lane 3, Lane 4, Lane 5, or Lane 6 work, the coordinator prompt is authoritative for lane, scope, branch name, claim requirements, and forbidden files.
