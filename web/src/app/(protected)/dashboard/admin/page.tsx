...
export default async function AdminDashboardPage() {
  ...
  const adminLinks = [
    ...
    { href: "/dashboard/admin/verifications", title: "Change Reports", description: "Review and verify community-submitted corrections" },
    { href: "/dashboard/admin/event-update-suggestions", title: "Review Suggestions", description: "Approve or reject user-submitted corrections (legacy)" },
    ...
    { href: "/dashboard/admin/newsletter", title: "Newsletter Subscribers", description: "View subscriber list and export emails for bulk sending" },
    { href: "/dashboard/admin/logs", title: "Application Logs", description: "Debug errors and monitor application activity" },
  ];
