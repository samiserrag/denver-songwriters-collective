  ...
  return (
    <div>
      ...
      {activeTab === "photos" && (
        <div>
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute top-2 left-2 flex gap-1">
                    ...
                    {image.is_featured && (
                      <span className="px-2 py-0.5 bg-gold-400 text-black text-xs rounded-full">
                        Featured
                      </span>
                    )}
                  </div>
          ...
          {filteredImages.length === 0 && (
            <p className="text-center text-neutral-400 py-8">No photos found.</p>
          )}
        </div>
      )}
      ...
      {activeTab === "albums" && (
        <div>
          {/* Create Album Form */}
          <form onSubmit={handleCreateAlbum} className="mb-8 p-4 bg-neutral-800/50 rounded-lg border border-white/10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input
                ...
                className="px-3 py-2 bg-neutral-900 border border-neutral-700 rounded-lg text-white placeholder:text-neutral-500"
                required
              />
              <input
                type="text"
            ...
            <button
              ...
              className="mt-4 px-4 py-2 bg-teal-600 hover:bg-teal-500 disabled:bg-teal-900 text-white rounded-lg transition-colors"
            >
                ...
                <div className="p-4">
                  <div className="flex items-start justify-between mb-2">
                    <div>
                      ...
                      <p className="text-neutral-500 text-xs">/{album.slug}</p>
                    </div>
                    <span
      ...
      {activeTab === "upload" && (
        <form onSubmit={handleUpload} className="max-w-xl space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm text-neutral-300 mb-2">Venue</label>
              <select
                value={uploadVenue}
                onChange={(e) => setUploadVenue(e.target.value)}
                className="w-full px-4 py-3 rounded-lg bg-neutral-800 border border-neutral-600 text-white focus:border-teal-500 focus:outline-none"
              >
          ...
          <div>
            <label className="block text-sm text-neutral-300 mb-2">Album</label>
            <select
              value={uploadAlbum}
