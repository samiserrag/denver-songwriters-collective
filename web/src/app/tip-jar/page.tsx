      ...
      <PageContainer>
        <div className="py-16 space-y-12 max-w-3xl mx-auto">
          ...
          <section className="space-y-6">
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              ...
              >
                ...
                <h3 className="text-[length:var(--font-size-heading-sm)] font-[var(--font-family-serif)] text-[var(--color-gold)] group-hover:text-[var(--color-gold-300)] transition-colors">
                  Venmo
                </h3>
          ...
          <div className="text-center pt-8">
            <Link
              href="/about"
              className="text-[var(--color-gold)] hover:text-[var(--color-gold-300)] underline"
            >
              ← Back to About
            </Link>
          </div>
