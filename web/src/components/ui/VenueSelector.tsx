    ...
    <div className="space-y-3">
      <div>
        ...
        <select
          ...
          className="w-full px-4 py-3 bg-[var(--color-indigo-950)]/50 border border-white/10 rounded-lg text-[var(--color-warm-white)] focus:border-[var(--color-gold)] focus:outline-none disabled:opacity-50"
        >
      ...
      {showNewVenueForm && (
        <div className="p-4 bg-[var(--color-indigo-950)]/30 border border-[var(--color-gold)]/20 rounded-lg space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="md:col-span-2">
              <input
                ...
                className="w-full px-3 py-2 bg-[var(--color-indigo-950)]/50 border border-white/10 rounded-lg text-[var(--color-warm-white)] text-sm placeholder:text-[var(--color-warm-gray)] focus:border-[var(--color-gold)] focus:outline-none"
                disabled={creating}
              />
            </div>
            <div className="md:col-span-2">
          ...
          <button
            ...
            className="px-4 py-2 bg-[var(--color-gold)] hover:bg-[var(--color-gold-400)] disabled:opacity-50 disabled:cursor-not-allowed rounded-lg text-[var(--color-background)] text-sm font-medium transition-colors"
          >
