...
function SocialIcon({ platform, className }: { platform: string; className: string }) {
  ...
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" d="M13.828 10.172a4 4 0 0 0-5.656 0l-3 3a4 4 0 1 0 5.656 5.656l1.5-1.5m-2.672-7.156a4 4 0 0 1 5.656 0l3 3a4 4 0 1 1-5.656 5.656l-1.5-1.5" />
    </svg>
  );
}
