...
export function VolunteerSignupForm() {
  ...
  if (success) {
    return (
      <div className="rounded-2xl border border-teal-500/30 bg-teal-900/20 p-8 text-center space-y-4">
        ...
        <button
          ...
          className="mt-4 px-4 py-2 text-sm text-teal-400 hover:text-teal-300 underline"
        >
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 bg-neutral-900 border border-neutral-600 rounded-lg text-white focus:border-teal-500 focus:outline-none"
      ...
      <div>
        ...
        <textarea
          ...
          rows={4}
          className="w-full px-3 py-2 bg-neutral-900 border border-neutral-600 rounded-lg text-white focus:border-teal-500 focus:outline-none resize-none"
      ...
      <button
        type="submit"
        disabled={submitting}
        className="w-full px-6 py-3 bg-teal-600 hover:bg-teal-500 rounded-lg text-white font-semibold transition disabled:opacity-50 disabled:cursor-not-allowed"
      >
